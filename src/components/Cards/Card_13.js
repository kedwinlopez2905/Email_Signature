  ...
  return (
    <div className="relative px-4 py-8 mt-6 shadow-md rounded-2xl group">
      ...
      <div className="relative duration-300 cursor-pointer group-hover:blur-lg ">
        ...
        />
        <div className="flex mt-2 h-36">
          <div className="pr-4 border-r-2 border-[#450f07] mr-4 text-center">
            <img
              alt=""
              src="https://img.mysignature.io/p/7/e/e/7eedd948-c59c-5d4f-9c40-bfe8d5ec076d.png?time=1685569257"
              className="h-28 w-36"
            />
            <p className="text-[#450f07] text-[14px] my-1">Jamila Richmond</p>
            <p className=" text-[12px]">CMO &nbsp; at Fair</p>
          </div>
          <div className="flex items-center ">
            <div>
              <div className="flex">
                <h1 className="text-[#450f07] text-[12px]">mobile: &nbsp;</h1>
                <h1 className="text-[11px]">+45-562-90</h1>
              </div>
              <div className="flex">
                <h1 className="text-[#450f07] text-[12px]">website: &nbsp;</h1>
                <h1 className="text-[11px]">mysignature.io</h1>
              </div>
              <div className="flex">
                <h1 className="text-[#450f07] text-[12px]">email: &nbsp;</h1>
                <h1 className="text-[11px]">my@villegas.io</h1>
              </div>
              <div className="flex">
                <h1 className="text-[#450f07] text-[12px]">phone: &nbsp;</h1>
                <h1 className="text-[11px]">+50-230-48</h1>
              </div>
              <div className="flex gap-1 mt-2">
                <span className="bg-[#453107] flex justify-center items-center rounded-[10%] w-[20px] text-center text-[12px] h-[20px]">
                  <svg
        ...
        <div className="mt-6">
          <img
            alt=""
            src="https://img.mysignature.io/b/7/e/e/7eedd948-c59c-5d4f-9c40-bfe8d5ec076d.png?time=1685569257"
            className="mt-6 mb-8"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          />
          <h1 className="text-[12px] text-center">Save paper. Don’t print</h1>
        </div>
      </div>
