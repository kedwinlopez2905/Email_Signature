    ...
    <div className="relative px-4 py-8 mt-6 shadow-md rounded-2xl group">
      ...
      <div className="relative duration-300 cursor-pointer group-hover:blur-lg ">
        <div className="flex">
          ...
          <div className="">
            <h1 className="text-[14px] text-[#231e1c]">August Mcmanus</h1>
            <p className="text-[12px] text-[#231e1c]">
              Creative Director at Varazil
            </p>
            <div className="flex">
              <h1 className="text-[#231e1c] text-[12px]">mobile: &nbsp;</h1>
              <h1 className="text-[11px]">+45-562-90</h1>
            </div>
            <div className="flex">
              <h1 className="text-[#231e1c] text-[12px]">website: &nbsp;</h1>
              <h1 className="text-[11px]">mysignature.io</h1>
            </div>
            <div className="flex">
              <h1 className="text-[#231e1c] text-[12px]">email: &nbsp;</h1>
              <h1 className="text-[11px]">my@villegas.io</h1>
            </div>
            <div className="flex">
              <h1 className="text-[#231e1c] text-[12px]">phone: &nbsp;</h1>
              <h1 className="text-[11px]">+50-230-48</h1>
            </div>
            <div className="flex gap-1">
              <span className="bg-[#1cc34e] flex justify-center items-center rounded-[10%] w-[20px] text-center text-[12px] h-[20px]">
                <svg
        ...
        <div className="flex gap-2">
            <img alt="" src="https://img.mysignature.io/addons/v2/leaf.png"/>
            <p className="text-[10px]">Please consider the environment before printing this email</p>
        </div>
      </div>
