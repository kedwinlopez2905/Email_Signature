    ...
    <div className="relative px-4 py-8 mt-6 shadow-md rounded-2xl group">
      ...
      <div className="relative duration-300 cursor-pointer group-hover:blur-lg ">
        <div className="flex items-center justify-center">
          <div className="pr-2 mr-2 border-r-2 border-red-600">
            <img
              alt=""
          ...
          <div className="ml-2">
            <h1 className="text-[14px]">Jeremy Flatik</h1>
            <h1 className="text-[11px]">
              email: &nbsp; jeremy@mysignature.io
              <br />
              Watch reviews at SReviews
            </h1>
            <div className="flex gap-2">
              <span className="bg-[#ffffff] flex justify-center items-center rounded-[10%] w-[28px] text-center text-[12px] h-[28px]">
                <svg
        ...
        <div className="flex gap-2 mt-4 mb-4">
          <img
            alt=""
            src="https://img.mysignature.io/addons/v2/youtube_v2_shape3_i.png"
            className="w-24 h-8"
          />
          <img
            alt=""
            src="https://img.mysignature.io/addons/v2/instagram_v2_shape3_i.png"
            className="w-24 h-8"
          />
          <img
            alt=""
